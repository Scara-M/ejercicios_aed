...
• Se pide cargar un vector que contenga el nombre de las estaciones y otros dos que representen el viaje de ida y de vuelta del tren, respectivamente. 
En los dos últimos, se cargará la cantidad de pasajeros que ascendieron al tren en la estación correspondiente.
...
• 3. En qué estación subió la mayor canƟdad de pasajeros, durante el viaje de ida
...
• 5. Mostrar las estaciones en las que la canƟdad de pasajeros del viaje de ida fue mayor a la del
viaje de vuelta
"""